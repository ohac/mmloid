...
helper(100, "え", "D4", "480@120+28.0", 50, 30.0, 600, 59.0, 48.0, 96, 0,
"!120.00",
...
helper(100, "る", "E4", "480@120+42.0", 48, 23.0, 600, 104.0, 56.0, 100, 0,
"!120.00",
...
helper(100, "の", "F4", "480@120+79.0", 29, 19.0, 650, 77.0, 65.0, 100, 0,
"!120.00",
...
helper(100, "う", "E4", "480@120+6.0", 50, 23.0, 550, 52.0, 37.0, 96, 0,
"!120.00",
...
helper(100, "た", "D4", "480@120+20.0", 34, 29.0, 550, 67.0, 91.0, 100, 0,
"!120.00",
...
helper(100, "が", "C4", "480@120+42.0", 42, 24.0, 600, 96.0, 47.0, 100, 0,
"!120.00",
...
helper(100, "き", "E4", "480@120+14.0", 52, 15.0, 550, 108.0, 41.0, 100, 0,
"!120.00",
"AA#51#/7/8/+/+//AAABACAEAGAHAJALAMAN#2#AMAKAIAFAC///7/4/1/z/x/w/w/x/y/0/2/4/6/8/+AAACADAE#3#ADADAC",
"0 5 35 0 100 100 0 -10")

helper(100, "こ", "F4", "480@120+73.0", 23, 22.0, 600, 86.0, 98.0, 100, 0,
"!120.00",
...
helper(100, "え", "G4", "480@120+16.0", 50, 30.0, 550, 59.0, 48.0, 96, 0,
"!120.00",
"AA#60#ABACADAEAFAFAGAFAFAEACAA/+/7/4/1/y/w/u/s/t/v/x/0/3/6/9//ACADAFAG#3#AFAEADAC",
"100 0 35 100 100 100 0 100")

helper(100, "て", "A4", "480@120+28.0", 24, 22.0, 550, 62.0, 65.0, 100, 0,
"!120.00",
"AA#47#ABABAA///+/9/8/6/5/3/2/1#2#/2/3/5/7/+ABAFAIAMAOAQ#3#APANALAJAGAEAC///8/5/1/y/u/p/l/h/a/V",
"0 5 35 0 100 100 0 -10")

helper(100, "く", "G4", "480@120+12.0", 34, 26.0, 550, 87.0, 53.0, 100, 0,
"!120.00",
...
helper(100, "る", "F4", "480@120+16.0", 48, 23.0, 550, 104.0, 56.0, 100, 0,
"!120.00",
...
helper(100, "よ", "E4", "480@120+71.0", 71, 5.0, 600, 282.0, 31.0, 100, 0,
"!120.00",
